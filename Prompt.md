...
- Canonical MVP implementation precedence is `Proofound_MVP_Locked_Source_of_Truth_2026-03-11.md`, then `PRD_for_a_web_platform_MVP.master-latest.md`, then `PRD_TECHNICAL_REQUIREMENTS.md`, then `LAUNCH_RUNBOOK.md`. Broader strategy docs such as `Proofound_Project_Specification_2026-03-11.md` are reference only. (source: Proofound_MVP_Locked_Source_of_Truth_2026-03-11.md, PRD_for_a_web_platform_MVP.master-latest.md, PRD_TECHNICAL_REQUIREMENTS.md, LAUNCH_RUNBOOK.md, Proofound_Project_Specification_2026-03-11.md)
