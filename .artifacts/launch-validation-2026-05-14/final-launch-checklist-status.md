...
Generated: 2026-05-14T10:43:52.237Z
Scope: `repo`
Workspace: `/Users/yuriibakurov/proofound`
Git: `master` @ `0cd61d6944dab03348cbee44322861230dc8c1a3`
Verdict: `NOT_READY`
Live base URL: `http://127.0.0.1:64104`
Latest launch-validation bundle: `.artifacts/launch-validation-2026-05-14`
...
- Product — Public portfolio is calm, safe, and separate from review reveal: No current evidence source resolved this checklist line.
- Product — Org trust page is minimal and live: Seeded public org trust fixture live failed
...
- QA — Public-org trust smoke passes: Seeded public org trust fixture live failed

## External Prerequisites

- Founder / GTM — Go/no-go is signed only after fresh evidence is green: Blocked by upstream checklist items: engineering_launch_status_fresh_evidence. The dated launch signoff memo records a GO decision after fresh launch evidence turned green.

## Missing Evidence

- Product — Public portfolio is calm, safe, and separate from review reveal
...
- [PASS] Private context scaffolding works for work / volunteering / education
  ...
  - Evidence: Repo-ready private context validation evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-private-context.log`
- [UNVERIFIED] Public portfolio is calm, safe, and separate from review reveal
...
- [FAIL] Org trust page is minimal and live
  - Summary: Seeded public org trust fixture live failed
  - Evidence: Latest launch bundle org trust smoke evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-launch-smoke-report.json`; Latest launch bundle org trust smoke evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-launch-smoke.log`
...
- [PASS] `npm run build` passes cleanly under launch Node version
  ...
  - Evidence: Latest launch bundle prod build evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-build.log`
- [PASS] `next start` is stable
  - Summary: `npm run start` booted successfully and `/api/health` returned ok.
  - Evidence: Latest launch bundle prod boot evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-prod-start.log`; Latest launch bundle prod boot evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-prod-health.json`
- [PASS] Route surface is reduced to the launch allowlist
  ...
  - Evidence: Latest launch bundle route-surface gate evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-route-surface.log`
...
- [FAIL] Launch-status and smoke-artifact logic run on fresh evidence
  ...
  - Evidence: Launch-status route evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-launch-status-route.log`; Launch smoke evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-launch-smoke-report.json`; Launch smoke evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-launch-smoke.log`
...
- [FAIL] Public-org trust smoke passes
  - Summary: Seeded public org trust fixture live failed
  - Evidence: Latest launch bundle public org trust smoke evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-launch-smoke-report.json`; Latest launch bundle public org trust smoke evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-launch-smoke.log`
...
- [PASS] Manual privacy leak sweep passes
  ...
  - Evidence: Repo-ready manual privacy validation evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-manual-privacy.log`
- [PASS] Workflow email privacy sweep passes
  - Summary: Workflow email privacy tests passed for masked and pre-reveal flows.
  - Evidence: Repo-ready workflow email privacy validation evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-workflow-email-privacy.log`
...
- [PASS] Final evidence packet is assembled and dated
  ...
  - Evidence: Generated Markdown report: `.artifacts/launch-validation-2026-05-14/final-launch-checklist-status.md`; Generated JSON bundle: `.artifacts/launch-validation-2026-05-14/final-launch-checklist-status.json`
...
- [PASS] Internal ops/admin surfaces are protected and usable
  ...
  - Evidence: Repo-ready internal admin surface validation evidence: `.artifacts/launch-validation-2026-05-14/repo-ready-internal-admin.log`
...
- [BLOCKED] Go/no-go is signed only after fresh evidence is green
  - Summary: Blocked by upstream checklist items: engineering_launch_status_fresh_evidence. The dated launch signoff memo records a GO decision after fresh launch evidence turned green.
