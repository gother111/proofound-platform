...
Generated: 2026-04-14T23:28:46.397Z
Scope: `repo`
Workspace: `/Users/yuriibakurov/proofound`
Git: `master` @ `1539dd00f4bfe78d3d5c02f5201c2958566e007d`
Verdict: `NOT_READY`
Live base URL: `http://127.0.0.1:51655`
Latest launch-validation bundle: `.artifacts/launch-validation-2026-04-14`
...
- Founder / GTM — Go/no-go is signed only after fresh evidence is green: Blocked by upstream checklist items: engineering_launch_status_fresh_evidence. No current evidence source resolved this checklist line.
...
- [PASS] Private context scaffolding works for work / volunteering / education
  ...
  - Evidence: Repo-ready private context validation evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-private-context.log`
- [PASS] Public portfolio is calm, safe, and separate from review reveal
  ...
  - Evidence: Launch smoke gate: `.artifacts/launch-validation-2026-04-14/24_gate_summary.json`; Verification checklist: blind review: `docs/verification-checklist.md`; Verification checklist: consented reveal: `docs/verification-checklist.md`
- [PASS] Org trust page is minimal and live
  - Summary: Public org trust smoke scenario passed in the fresh launch smoke artifact.
  - Evidence: Latest launch bundle org trust smoke evidence: `.artifacts/launch-smoke-report.json`; Latest launch bundle org trust smoke evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-launch-smoke.log`
...
- [PASS] `npm run build` passes cleanly under launch Node version
  ...
  - Evidence: Latest launch bundle prod build evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-build.log`
- [PASS] `next start` is stable
  - Summary: `npm run start` booted successfully and `/api/health` returned healthy.
  - Evidence: Latest launch bundle prod boot evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-prod-start.log`; Latest launch bundle prod boot evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-prod-health.json`
- [PASS] Route surface is reduced to the launch allowlist
  ...
  - Evidence: Latest launch bundle route-surface gate evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-route-surface.log`
...
- [FAIL] Launch-status and smoke-artifact logic run on fresh evidence
  ...
  - Evidence: Launch-status route evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-launch-status-route.log`; Launch smoke evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-launch-smoke.log`
...
- [PASS] Public-org trust smoke passes
  - Summary: Public org trust smoke scenario passed in the fresh launch smoke artifact.
  - Evidence: Latest launch bundle public org trust smoke evidence: `.artifacts/launch-smoke-report.json`; Latest launch bundle public org trust smoke evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-launch-smoke.log`
...
- [PASS] Manual privacy leak sweep passes
  ...
  - Evidence: Repo-ready manual privacy validation evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-manual-privacy.log`
- [PASS] Workflow email privacy sweep passes
  - Summary: Workflow email privacy tests passed for masked and pre-reveal flows.
  - Evidence: Repo-ready workflow email privacy validation evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-workflow-email-privacy.log`
...
- [PASS] Final evidence packet is assembled and dated
  ...
  - Evidence: Generated Markdown report: `.artifacts/launch-validation-2026-04-14/final-launch-checklist-status.md`; Generated JSON bundle: `.artifacts/launch-validation-2026-04-14/final-launch-checklist-status.json`
...
- [PASS] Internal ops/admin surfaces are protected and usable
  ...
  - Evidence: Repo-ready internal admin surface validation evidence: `.artifacts/launch-validation-2026-04-14/repo-ready-internal-admin.log`
...
- [BLOCKED] Go/no-go is signed only after fresh evidence is green
  - Summary: Blocked by upstream checklist items: engineering_launch_status_fresh_evidence. No current evidence source resolved this checklist line.
  - Evidence: Configured evidence source: `.artifacts/launch-readiness-summary.md`; Configured evidence source: `.artifacts/launch-validation-*/24_gate_summary.json`
