...
| proof-review-participant-consented reveal                                             | `PASS` | `P1`     | `tests/api/conversation-reveal-route.test.ts` passed, and the strict assignment-review rerun reached reveal approval and identity unlock.                                                                                                                                                                                                                                                   | Reveal consent is freshly rerun, not inferred from older audits.                                          |
...
| review -> intro -> reveal -> interview -> decision -> hire -> engagement verification | `PASS` | `P0`     | Isolated strict assignment-review rerun passed `1/1`, full org strict rerun passed `7/7`, and live smoke passed the `full_org_corridor_review_to_engagement_verification` scenario.                                                                                                                                                                                                         | The proof-review workflow reaches explicit `hire` and is freshly green in this pass.                      |
