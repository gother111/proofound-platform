...
- Small to mid-sized mission-driven organizations hiring for work where proof quality matters more than credential theater.
- First buyers are founder-led or operator-led teams with one concrete assignment, a clear review owner, and willingness to use a narrow pilot process.
- Exclude broad self-serve marketplace use, anonymous mass candidate pools, generic recruiter tooling, and multi-department enterprise rollout.

First-wave design partners:

- 3 to 5 organizations that can provide one live assignment each.
- Each partner must name one hiring/review owner, one support contact, and one post-pilot feedback owner.
- Partners are frozen for this launch wave until the first pilot loop is complete.
...
- Pilot is founder-led and manually supported.
- Pricing remains simple and pilot-specific until there is enough evidence to productize.
- Case-study permission is requested only after the partner has seen a complete corridor outcome.
...
1. Confirm the organization matches the launch ICP.
2. Assign the organization owner, review owner, support contact, and feedback owner.
...
- Do not broaden the product surface during the pilot.
- Do not promise automated matching, broad marketplace depth, or enterprise workflow coverage.
- Do not publish partner or candidate stories without explicit consent.
