...
export function NetworkBackground() {
  ...
  useEffect(() => {
    ...
    const types: Array<'person' | 'organization' | 'government'> = ['person', 'organization', 'government'];
                  ...
                  >
                    <motion.circle
                      ...
                      animate={{
                        ...
                        opacity: [LAYER_OPACITIES[layer] * 0.8, LAYER_OPACITIES[layer] * 0.2, LAYER_OPACITIES[layer] * 0.8]
                      }}
                      transition={{
                        duration: 6 + i * 0.8,
                        repeat: Infinity,
