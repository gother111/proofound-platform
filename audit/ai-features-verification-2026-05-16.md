...
10. **The primary AI launch test command did not cover every AI-specific local suite.**
    ...
    - Regression: the expanded command now passes as a composite AI gate with 40 files / 292 tests across the default and archived-admin configs.
...
11. **Default-excluded AI guardrail suites could be missed by a path-only launch command.**
    ...
    - Regression: `npm run test:launch:ai` now proves 39 default-config files / 291 tests, then `tests/ui/admin-ai-spend-page.test.tsx` through the archived config.

## Checks Run

| Check                           | Status                   | Notes                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run test:launch:ai`        | PASS                     | Composite gate: 39 default-config files / 291 tests, plus archived admin AI boundary 1 file / 1 test through `vitest.archived.config.ts`. Vitest printed local websocket `EPERM` noise but all suites passed.                                                                                                                                                                                                              |
