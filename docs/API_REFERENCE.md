...
- Total route handlers: **138**
- Auth tier counts: `public=47`, `session=79`, `service=2`, `cron=10`
- Family count: **31**
...
| Methods | Path                                                 | Auth Tier | Notes | Source                                                               |
| ------- | ---------------------------------------------------- | --------- | ----- | -------------------------------------------------------------------- |
| `POST`  | `/api/ai/assignments/clarify`                        | `session` | -     | `src/app/api/ai/assignments/clarify/route.ts`                        |
| `POST`  | `/api/ai/privacy-preflight/check`                    | `session` | -     | `src/app/api/ai/privacy-preflight/check/route.ts`                    |
| `POST`  | `/api/ai/proof-pack/suggest`                         | `session` | -     | `src/app/api/ai/proof-pack/suggest/route.ts`                         |
| `POST`  | `/api/ai/start-from-cv/sessions`                     | `public`  | -     | `src/app/api/ai/start-from-cv/sessions/route.ts`                     |
| `GET`   | `/api/ai/start-from-cv/sessions/[sessionId]`         | `public`  | -     | `src/app/api/ai/start-from-cv/sessions/[sessionId]/route.ts`         |
| `POST`  | `/api/ai/start-from-cv/sessions/[sessionId]/accept`  | `public`  | -     | `src/app/api/ai/start-from-cv/sessions/[sessionId]/accept/route.ts`  |
| `POST`  | `/api/ai/start-from-cv/sessions/[sessionId]/discard` | `public`  | -     | `src/app/api/ai/start-from-cv/sessions/[sessionId]/discard/route.ts` |
| `POST`  | `/api/ai/start-from-cv/sessions/[sessionId]/extract` | `public`  | -     | `src/app/api/ai/start-from-cv/sessions/[sessionId]/extract/route.ts` |
| `GET`   | `/api/ai/start-from-cv/status`                       | `public`  | -     | `src/app/api/ai/start-from-cv/status/route.ts`                       |
| `POST`  | `/api/ai/suggestions/events`                         | `session` | -     | `src/app/api/ai/suggestions/events/route.ts`                         |
| `POST`  | `/api/ai/verifications/compose`                      | `session` | -     | `src/app/api/ai/verifications/compose/route.ts`                      |
...
| `POST`      | `/api/analytics/tour-event` | `public`  | legacy/compat markers in source | `src/app/api/analytics/tour-event/route.ts` |
| `POST`      | `/api/analytics/track`      | `public`  | legacy/compat markers in source | `src/app/api/analytics/track/route.ts`      |
| `GET\|POST` | `/api/analytics/web-vitals` | `public`  | legacy/compat markers in source | `src/app/api/analytics/web-vitals/route.ts` |

### assignments

| Methods            | Path                                     | Auth Tier | Notes | Source                                                   |
| ------------------ | ---------------------------------------- | --------- | ----- | -------------------------------------------------------- |
| `GET\|POST`        | `/api/assignments`                       | `session` | -     | `src/app/api/assignments/route.ts`                       |
| `GET\|PUT\|DELETE` | `/api/assignments/[id]`                  | `session` | -     | `src/app/api/assignments/[id]/route.ts`                  |
| `GET\|POST`        | `/api/assignments/[id]/expertise-matrix` | `session` | -     | `src/app/api/assignments/[id]/expertise-matrix/route.ts` |
| `GET\|POST`        | `/api/assignments/[id]/outcomes`         | `session` | -     | `src/app/api/assignments/[id]/outcomes/route.ts`         |
| `GET\|POST`        | `/api/assignments/[id]/pipeline`         | `session` | -     | `src/app/api/assignments/[id]/pipeline/route.ts`         |
| `POST`             | `/api/assignments/[id]/publish`          | `session` | -     | `src/app/api/assignments/[id]/publish/route.ts`          |
...
| Methods         | Path                                               | Auth Tier | Notes                           | Source                                                             |
| --------------- | -------------------------------------------------- | --------- | ------------------------------- | ------------------------------------------------------------------ |
| `POST`          | `/api/expertise/cv-import/wizard-apply`            | `public`  | legacy/compat markers in source | `src/app/api/expertise/cv-import/wizard-apply/route.ts`            |
| `POST`          | `/api/expertise/cv-import/wizard-extract`          | `public`  | legacy/compat markers in source | `src/app/api/expertise/cv-import/wizard-extract/route.ts`          |
| `GET`           | `/api/expertise/cv-import/wizard-extract/status`   | `public`  | legacy/compat markers in source | `src/app/api/expertise/cv-import/wizard-extract/status/route.ts`   |
| `POST`          | `/api/expertise/cv-import/wizard-suggest`          | `public`  | legacy/compat markers in source | `src/app/api/expertise/cv-import/wizard-suggest/route.ts`          |
| `POST`          | `/api/expertise/jd-to-l4`                          | `session` | -                               | `src/app/api/expertise/jd-to-l4/route.ts`                          |
| `GET`           | `/api/expertise/taxonomy`                          | `service` | -                               | `src/app/api/expertise/taxonomy/route.ts`                          |
| `GET\|POST`     | `/api/expertise/user-skills`                       | `session` | legacy/compat markers in source | `src/app/api/expertise/user-skills/route.ts`                       |
| `PATCH\|DELETE` | `/api/expertise/user-skills/[id]`                  | `session` | -                               | `src/app/api/expertise/user-skills/[id]/route.ts`                  |
| `GET\|POST`     | `/api/expertise/user-skills/[id]/proofs`           | `session` | legacy/compat markers in source | `src/app/api/expertise/user-skills/[id]/proofs/route.ts`           |
| `DELETE`        | `/api/expertise/user-skills/[id]/proofs/[proofId]` | `session` | legacy/compat markers in source | `src/app/api/expertise/user-skills/[id]/proofs/[proofId]/route.ts` |
...
| Methods | Path                        | Auth Tier | Notes | Source                                      |
| ------- | --------------------------- | --------- | ----- | ------------------------------------------- |
| `GET`   | `/api/individual/readiness` | `session` | -     | `src/app/api/individual/readiness/route.ts` |
...
| `POST`              | `/api/match/gates`                    | `session` | -                               | `src/app/api/match/gates/route.ts`                    |
| `GET\|POST\|DELETE` | `/api/match/hide`                     | `session` | legacy/compat markers in source | `src/app/api/match/hide/route.ts`                     |
...
| `GET`               | `/api/match/snoozed`                  | `session` | -                               | `src/app/api/match/snoozed/route.ts`                  |
| `GET`               | `/api/match/test`                     | `public`  | -                               | `src/app/api/match/test/route.ts`                     |
...
| Methods        | Path                       | Auth Tier | Notes | Source                                     |
| -------------- | -------------------------- | --------- | ----- | ------------------------------------------ |
| `POST\|DELETE` | `/api/matches/[id]/snooze` | `session` | -     | `src/app/api/matches/[id]/snooze/route.ts` |
...
| Methods | Path                                 | Auth Tier | Notes                           | Source                                               |
| ------- | ------------------------------------ | --------- | ------------------------------- | ---------------------------------------------------- |
| `GET`   | `/api/monitoring/health-diagnostics` | `service` | -                               | `src/app/api/monitoring/health-diagnostics/route.ts` |
...
| Methods | Path                                     | Auth Tier | Notes | Source                                                   |
| ------- | ---------------------------------------- | --------- | ----- | -------------------------------------------------------- |
| `POST`  | `/api/org/[id]/matches/[matchId]/review` | `session` | -     | `src/app/api/org/[id]/matches/[matchId]/review/route.ts` |
| `GET`   | `/api/org/[id]/shortlist`                | `session` | -     | `src/app/api/org/[id]/shortlist/route.ts`                |
| `GET`   | `/api/org/readiness`                     | `session` | -     | `src/app/api/org/readiness/route.ts`                     |
...
| `GET\|PUT`  | `/api/organizations/[orgId]`                              | `session` | -                               | `src/app/api/organizations/[orgId]/route.ts`                              |
| `GET`       | `/api/organizations/[orgId]/assignments`                  | `public`  | -                               | `src/app/api/organizations/[orgId]/assignments/route.ts`                  |
| `GET`       | `/api/organizations/[orgId]/audit/export`                 | `session` | -                               | `src/app/api/organizations/[orgId]/audit/export/route.ts`                 |
...
| `GET`       | `/api/organizations/[orgId]/team`                         | `session` | -                               | `src/app/api/organizations/[orgId]/team/route.ts`                         |
...
| Methods | Path                     | Auth Tier | Notes                           | Source                                   |
| ------- | ------------------------ | --------- | ------------------------------- | ---------------------------------------- |
| `POST`  | `/api/performance/track` | `public`  | legacy/compat markers in source | `src/app/api/performance/track/route.ts` |
...
| Methods | Path                                                      | Auth Tier | Notes | Source                                                                    |
| ------- | --------------------------------------------------------- | --------- | ----- | ------------------------------------------------------------------------- |
| `POST`  | `/api/proof-artifacts/[artifactId]/text-extraction`       | `session` | -     | `src/app/api/proof-artifacts/[artifactId]/text-extraction/route.ts`       |
| `POST`  | `/api/proof-artifacts/[artifactId]/text-extraction/apply` | `session` | -     | `src/app/api/proof-artifacts/[artifactId]/text-extraction/apply/route.ts` |
| `GET`   | `/api/proof-artifacts/text-extraction/status`             | `session` | -     | `src/app/api/proof-artifacts/text-extraction/status/route.ts`             |
...
| `POST`        | `/api/user/account/cancel-deletion` | `session` | -                               | `src/app/api/user/account/cancel-deletion/route.ts` |
| `GET`         | `/api/user/audit-log`               | `session` | -                               | `src/app/api/user/audit-log/route.ts`               |
...
| `GET`         | `/api/user/export`                  | `session` | legacy/compat markers in source | `src/app/api/user/export/route.ts`                  |
...
| `GET\|POST\|PATCH` | `/api/verification/requests/bundles/[requestId]`       | `session` | -     | `src/app/api/verification/requests/bundles/[requestId]/route.ts`       |
...
| `/api/analytics/tour-event`                        | `src/app/api/analytics/tour-event/route.ts`                        | legacy/deprecated text present |
| `/api/analytics/track`                             | `src/app/api/analytics/track/route.ts`                             | legacy/deprecated text present |
| `/api/analytics/web-vitals`                        | `src/app/api/analytics/web-vitals/route.ts`                        | legacy/deprecated text present |
...
| `/api/expertise/cv-import/wizard-apply`            | `src/app/api/expertise/cv-import/wizard-apply/route.ts`            | legacy/deprecated text present |
| `/api/expertise/cv-import/wizard-extract`          | `src/app/api/expertise/cv-import/wizard-extract/route.ts`          | legacy/deprecated text present |
| `/api/expertise/cv-import/wizard-extract/status`   | `src/app/api/expertise/cv-import/wizard-extract/status/route.ts`   | legacy/deprecated text present |
| `/api/expertise/cv-import/wizard-suggest`          | `src/app/api/expertise/cv-import/wizard-suggest/route.ts`          | legacy/deprecated text present |
...
| `/api/performance/track`                           | `src/app/api/performance/track/route.ts`                           | legacy/deprecated text present |
