...
| `weekly digest`                                      | allowed historical/advisory                                      | Current occurrences state the standalone route is disabled or removed from active launch infrastructure; digest delivery piggybacks on the consolidated decision-reminders dispatcher.                                                      |
