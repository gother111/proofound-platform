...
export const colors = {
  ...
  dark: {
    ...
    surface: '#252936',         // Card backgrounds
...
export const commonStyles = {
  ...
  card: {
    ...
    className: 'bg-white dark:bg-[#252936] border border-[#E8E6DD] dark:border-[#D4C4A8]/10 rounded-lg',
  },
  ...
  header: {
    ...
    backgroundDark: colors.dark.surface,
    border: colors.brand.stone,
    className: 'bg-[#FDFCFA] dark:bg-[#252936] border-b border-[#E8E6DD] dark:border-[#D4C4A8]/10',
  },
  ...
  button: {
    primary: {
      ...
      className: 'bg-[#1C4D3A] dark:bg-[#D4C4A8] text-white dark:text-[#1A1D2E]',
    },
    
    secondary: {
      background: colors.brand.terracotta,
      text: colors.surfaces.white,
      className: 'bg-[#C76B4A] text-white',
    },
  },
