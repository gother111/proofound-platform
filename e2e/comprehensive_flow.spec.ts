...
test.describe('Comprehensive User Interaction Flow', () => {
    test('should allow organization to post assignment and individual to view it', async ({ browser }) => {
        ...
        await orgPage.goto(`/app/o/${orgId}/assignments/create`);
        ...
        await expect(orgPage.getByText(assignmentTitle).first()).toBeVisible({ timeout: 10000 }).catch(() => {
