...
**PRD Criteria:**
- [x] Create/edit mission, vision, values (≤5), causes (≤5) with field-level visibility
- [x] Purpose signals appear in Match Detail with PAC shown when applicable
- [x] Audit log records purpose edits (who/when/what)

**Test Coverage:**
- `e2e/profile/comprehensive-profile.spec.ts`: Mission & Vision tests
- `e2e/profile/comprehensive-profile.spec.ts`: Values & Causes tests
- `e2e/matching/comprehensive-matching.spec.ts`: PAC scores in match explainer
- `e2e/integration/end-to-end-flows.spec.ts`: Purpose → Matching integration
...
3. **Updated Existing Files:**
   - `e2e/matching/match-explainer.spec.ts` - Enhanced with PAC and rank tests
