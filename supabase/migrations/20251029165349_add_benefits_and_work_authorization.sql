...
-- version: 20251029165349
-- name: add_benefits_and_work_authorization
--
...
ALTER TABLE matching_profiles ADD COLUMN IF NOT EXISTS availability_bitmap BIT(336);
