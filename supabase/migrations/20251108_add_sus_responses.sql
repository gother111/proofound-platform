...
-- Indexes
CREATE INDEX idx_sus_responses_user ON sus_responses(user_id);
CREATE INDEX idx_sus_responses_submitted ON sus_responses(submitted_at DESC);
CREATE INDEX idx_sus_responses_score ON sus_responses(total_score);
