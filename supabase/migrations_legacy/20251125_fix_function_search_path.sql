...
DO $$
DECLARE
    funcs_to_check TEXT[] := ARRAY[
        'auto_populate_field_visibility',
        'skills_taxonomy_search_vector_update',
        'update_competency_label',
        'update_skill_computed_fields',
        'update_assignment_creation_status',
        'update_skill_proofs_updated_at',
        'update_video_integrations_updated_at',
        'update_decisions_updated_at',
        'update_profile_snippets_updated_at',
        'expire_verification_requests',
        'is_pipeline_complete',
        'get_current_pipeline_step',
        'compute_skill_last_used',
        'compute_skill_recency_multiplier',
        'compute_skill_evidence_strength',
        'compute_skill_impact_score',
        'get_skill_total_months',
        'get_user_active_skills',
        'calculate_benefits_match',
        'check_work_auth_compatible',
        'calculate_availability_overlap',
        'normalize_compensation_to_usd',
        'calculate_compensation_score',
        'skill_taxonomy_distance',
        'skill_adjacency_factor',
        'search_skills_smart',
        'is_org_member'
    ];
    func_name TEXT;
...
BEGIN
    FOREACH func_name IN ARRAY funcs_to_check
    LOOP
        ...
        IF NOT has_search_path THEN
            RAISE WARNING 'Function % may not have search_path set', func_name;
        END IF;
    END LOOP;
    
    RAISE NOTICE 'Function search_path verification completed for 27 functions';
END $$;
