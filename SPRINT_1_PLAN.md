...
- [IMPLEMENTATION_BACKLOG.md](docs/archive/IMPLEMENTATION_BACKLOG.md) - Historical backlog snapshot
- [SYSTEM_ARCHITECTURE_SUPPLEMENT.md](./SYSTEM_ARCHITECTURE_SUPPLEMENT.md) - Skills taxonomy design
- [Proofound_Matching_Conversation.md](docs/archive/legacy-platform/Proofound_Matching_Conversation.md) - Historical matching algorithm spec
