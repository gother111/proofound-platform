...
describe('launch gate package configuration', () => {
  ...
  it('keeps the locked MVP authority stack fresh and visibly classified', () => {
    ...
    const authorityDocs = [
      ...
      ['LAUNCH_RUNBOOK.aligned-rewrite.2026-03-11.md', 'repo+live', '2026-05-21', '2026-05-03'],
      [
    ...
    for (const [docPath, verificationSource, verifiedDate, registryDate] of authorityDocs) {
      ...
      expect(docsRegistry).toContain(
        `| \`${docPath}\` | \`active\` | \`root\` | \`${verificationSource}\` | \`${registryDate}\``
      );
    }
  ...
  it('keeps local developer setup and lint troubleshooting aligned with current scripts', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/local-dev.md`                                                                                     | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/TROUBLESHOOTING_LINT.md`                                                                          | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the accessibility go/no-go evidence current and honestly scoped', () => {
    ...
    expect(docsRegistry).toContain(
      '| `ACCESSIBILITY_AUDIT_REPORT.md`                                                                         | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps accessibility guidance aligned with current MVP launch gates', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/ACCESSIBILITY.md`                                                                                 | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/ACCESSIBILITY_TESTING_GUIDE.md`                                                                   | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps visual style and motion docs aligned with the active design contract', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/ANIMATION_NOTES.md`                                                                               | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/STYLEMAP.md`                                                                                      | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `DESIGN.md`                                                                                             | `active`         | `root`        | `repo`              | `2026-04-02`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/PROOFOUND_UBIQUITOUS_LANGUAGE.md`                                                                 | `active`         | `docs`        | `repo`              | `2026-05-06`  |'
    );
  });
  ...
  it('keeps active public landing and SEO copy proof-review led', () => {
    ...
    expect(publicLandingCopy).toContain('polished claims');
    ...
    expect(publicLandingCopy).toContain('proof-first assignment-review flow');
    expect(publicLandingCopy).toContain('structured assignment flow');
  ...
  it('keeps active route-count evidence aligned across launch docs', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/API_REFERENCE.md`                                                                                 | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain('> Last Verified: `2026-05-27`');
    expect(
      fs.existsSync(path.join(repoRoot, '.artifacts/mvp-surface-sweep-2026-05-19/SURFACE_SWEEP.md'))
    ).toBe(true);
    expect(docsRegistry).toContain(
      '| `docs/DOCS_REGISTRY.md`                                                                                 | `active`         | `docs`        | `repo+live`         | `2026-05-27`  |'
    );
    expect(docsRegistry).toContain(
      '| `.artifacts/proofound-current-state-reality-check.md`                                                   | `reference-spec` | `artifacts`   | `repo`              | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain(
      '| `.artifacts/launch-readiness-summary.md`                                                                | `reference-spec` | `artifacts`   | `repo`              | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain(
      '| `.artifacts/proofound-priority-file-map.md`                                                             | `reference-spec` | `artifacts`   | `repo`              | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/backlog/phase-5-launch-packaging.md`                                                              | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/backlog/README.md`                                                                                | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/backlog/dependency-map.md`                                                                        | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/backlog/phase-3-hiring-corridor.md`                                                               | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/verification-checklist.md`                                                                        | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
  });
  ...
  it('keeps the legacy go/no-go script archived and out of active docs', () => {
    ...
    const orientationRegistryDates: Record<string, string> = {
      'Architecture.md': '2026-05-04',
      'Documentation.md': '2026-03-12',
      'metrics.md': '2026-03-11',
      'Prompt.md': '2026-03-12',
      'verification.md': '2026-05-04',
      'project/Architecture.md': '2026-05-04',
      'project/Documentation.md': '2026-03-12',
      'project/Prompt.md': '2026-03-12',
    };
    const docsRegistry = fs.readFileSync(path.join(repoRoot, 'docs/DOCS_REGISTRY.md'), 'utf8');
    ...
    for (const docPath of orientationDocs) {
      ...
      expect(registryLine).toContain(`| \`${orientationRegistryDates[docPath]}\``);
    }
  ...
  it('keeps the release checklist aligned with current production-candidate gates', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/release-checklist.md`                                                                             | `active`         | `docs`        | `repo+live`         | `2026-03-01`  |'
    );
  });
  ...
  it('keeps go/no-go restore evidence tied to production-candidate targets', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/launch-restore-drill.md`                                                                          | `active`         | `docs`        | `repo+live`         | `2026-03-10`  |'
    );
  });
  ...
  it('keeps root production and provider docs aligned with manual-link launch posture', () => {
    ...
    expect(docsRegistry).toContain(
      '| `PRODUCTION_CHECKLIST.md`                                                                               | `active`         | `root`        | `repo+live`         | `2026-02-26`  |'
    );
    expect(docsRegistry).toContain(
      '| `OAUTH_SETUP_GUIDE.md`                                                                                  | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps retained mobile planning docs outside launch evidence', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/mobile/IOS_PARITY_MATRIX.md` | `reference-spec` | `docs` | `repo` | `2026-02-26` |'
    );
  });
  ...
  it('keeps retained database flow guidance aligned with restore-report evidence', () => {
    ...
    expect(docsRegistry).toContain(
      '| `test-db-flows.md`                                                                                      | `reference-spec` | `root`        | `repo`              | `2026-02-12`  |'
    );
  });
  ...
  it('keeps implementation contracts and milestones aligned with the locked corridor', () => {
    ...
    expect(docsRegistry).toContain(
      '| `Implement.md`                                                                                          | `active`         | `root`        | `repo+live`         | `2026-03-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `Plans.md`                                                                                              | `active`         | `root`        | `repo+live`         | `2026-03-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `project/Implement.md`                                                                                  | `active`         | `project`     | `repo+live`         | `2026-03-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `project/Plans.md`                                                                                      | `active`         | `project`     | `repo+live`         | `2026-03-12`  |'
    );
  });
  ...
  it('keeps broad reference specs visibly outside current MVP launch authority', () => {
    ...
    expect(docsRegistry).toContain(
      '| `DATA_REQUIREMENTS_AND_AI_STRATEGY.md`                                                                  | `reference-spec` | `root`        | `repo`              | `2026-02-12`  |'
    );
    ...
    for (const docPath of referenceDocs) {
      ...
      expect(registryLine).toContain('| `2026-02-12`');
    }
  });
  ...
  it('keeps the historical E2E PRD validation reference aligned with engage/close wording', () => {
    ...
    expect(docsRegistry).toContain(
      '| `e2e/PRD_CRITERIA_VALIDATION.md`                                                                        | `reference-spec` | `e2e`         | `repo`              | `2026-02-12`  |'
    );
  });
  ...
  it('keeps AI reference guardrails aligned to proof-review participant language', () => {
    ...
    for (const docPath of aiReferenceDocs) {
      ...
      expect(registryLine).toContain('| `2026-05-04`');
    }
  ...
  it('keeps the GCP OCR service reference non-decisional and workflow-scoped', () => {
    ...
    expect(docsRegistry).toContain(
      '| `services/gcp-cv-ocr/README.md` | `reference-spec` | `services` | `repo` | `2026-05-04` |'
    );
  });
  ...
  it('keeps broad reference snapshots from making current launch claims', () => {
    ...
    for (const docPath of [
      ...
      const registryLine = docsRegistry
        .split('\n')
        .find((line) => line.includes(`| \`${docPath}\``));
      expect(registryLine).toContain('| `2026-03-11`');
    }
    expect(docsRegistry).toContain(
      '| `USER_FLOWS_TECHNICAL_SPECIFICATIONS.md`                                                                | `reference-spec` | `root`        | `repo`              | `2026-03-11`  |'
    );
  });
  ...
  it('keeps active operator docs aligned with current deployment and provider gates', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/deployment-guide.md`                                                                              | `active`         | `docs`        | `repo+live`         | `2026-02-26`  |'
    );
    expect(docsRegistry).toContain(
      '| `agent/runbooks/setup.md`                                                                               | `active`         | `agent`       | `repo+live`         | `2026-02-26`  |'
    );
    expect(docsRegistry).toContain(
      '| `agent/checklists/verification.md`                                                                      | `active`         | `agent`       | `repo+live`         | `2026-05-04`  |'
    );
  });
  ...
  it('keeps synced preflight guidance aligned with current launch gates', () => {
    ...
    expect(docsRegistry).toContain(
      '| `agent/checklists/preflight.md`                                                                         | `active`         | `agent`       | `repo+live`         | `2026-02-26`  |'
    );
    expect(docsRegistry).toContain(
      '| `preflight.md`                                                                                          | `active`         | `root`        | `repo+live`         | `2026-02-26`  |'
    );
  });
  ...
  it('keeps GitHub launch workflows from requiring connected providers by default', () => {
    ...
    expect(docsRegistry).toContain(
      '| `.vercel-deploy-trigger.md`                                                                             | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the legacy Linear bulk import out of active launch operations', () => {
    ...
    expect(docsRegistry).toContain(
      '| `LINEAR_SETUP_INSTRUCTIONS.md`                                                                          | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps ticket closeout and sharded log guidance current and no-leak', () => {
    ...
    expect(docsRegistry).toContain(
      '| `agent/runbooks/proofound-ticket-finisher.md`                                                           | `active`         | `agent`       | `repo+live`         | `2026-03-06`  |'
    );
    expect(docsRegistry).toContain(
      '| `agent/scratchpad/README.md`                                                                            | `active`         | `agent`       | `repo+live`         | `2026-02-19`  |'
    );
    expect(docsRegistry).toContain(
      '| `project/changes/README.md`                                                                             | `active`         | `project`     | `repo+live`         | `2026-02-19`  |'
    );
    expect(docsRegistry).toContain(
      '| `agent/scratchpad.md`                                                                                   | `active`         | `agent`       | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps Resend setup guidance transactional, target-scoped, and privacy-safe', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/RESEND_SETUP.md`                                                                                  | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps vendor processing guidance evidence-scoped and privacy-safe', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/DATA_PROCESSING_AGREEMENTS.md`                                                                    | `active`         | `docs`        | `repo+live`         | `2026-03-11`  |'
    );
  });
  ...
  it('keeps privacy test guidance from overstating launch evidence', () => {
    ...
    expect(docsRegistry).toContain(
      '| `tests/privacy/README.md`                                                                               | `reference-spec` | `tests`       | `repo`              | `2026-02-12`  |'
    );
  });
  ...
  it('keeps historical load-test notes non-gating and target-scoped', () => {
    ...
    expect(docsRegistry).toContain(
      '| `tests/load/RESULTS.md`                                                                                 | `reference-spec` | `tests`       | `repo`              | `2026-02-12`  |'
    );
  });
  ...
  it('keeps privacy environment setup on the repo-owned migration path', () => {
    ...
    expect(docsRegistry).toContain(
      '| `tests/privacy/ENV_SETUP.md`                                                                            | `reference-spec` | `tests`       | `repo`              | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the integration test plan aligned with active test files', () => {
    ...
    expect(docsRegistry).toContain(
      '| `INTEGRATION_TEST_PLAN.md`                                                                              | `reference-spec` | `root`        | `repo`              | `2026-02-12`  |'
    );
    expect(
      fs.existsSync(path.join(repoRoot, 'src/archive/non_launch_evidence_pack/README.md'))
    ).toBe(true);
  });
  ...
  it('keeps LinkedIn verification guidance outside the launch corridor', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/LINKEDIN_VERIFICATION_SETUP.md`                                                                   | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
  });
  ...
  it('keeps support guidance aligned with self-service privacy and no-leak handling', () => {
    ...
    expect(docsRegistry).toContain(
      '| `EMAIL_SUPPORT_SETUP.md`                                                                                | `active`         | `root`        | `repo+live`         | `2026-03-11`  |'
    );
    expect(docsRegistry).toContain(
      '| `SUPPORT.md`                                                                                            | `active`         | `root`        | `repo+live`         | `2026-03-11`  |'
    );
  });
  ...
  it('keeps legacy PRD mirrors below the locked MVP authority stack', () => {
    ...
    expect(docsRegistry).toContain(
      '| `PRD_for_a_web_platform_MVP.md`                                                                         | `reference-spec` | `root`        | `repo`              | `2026-03-11`  |'
    );
    expect(docsRegistry).toContain(
      '| `Proofound_PRD_MVP.md`                                                                                  | `reference-spec` | `root`        | `repo`              | `2026-03-11`  |'
    );
  });
  ...
  it('keeps the root core user flows reference proof-submission scoped', () => {
    ...
    expect(docsRegistry).toContain(
      '| `Proofound_Core_User_Flows_v1.md`                                                                       | `reference-spec` | `root`        | `repo`              | `2026-03-11`  |'
    );
  });
  ...
  it('keeps legacy technical and runbook mirrors proof-review participant aligned', () => {
    ...
    expect(docsRegistry).toContain(
      '| `PRD_TECHNICAL_REQUIREMENTS.md`                                                                         | `reference-spec` | `root`        | `repo`              | `2026-03-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `LAUNCH_RUNBOOK.md`                                                                                     | `reference-spec` | `root`        | `repo`              | `2026-03-12`  |'
    );
  });
  ...
  it('keeps the preserved project specification below the active privacy language', () => {
    ...
    expect(docsRegistry).toContain(
      '| `Proofound_Project_Specification_2026-03-11.md`                                                         | `reference-spec` | `root`        | `repo`              | `2026-03-12`  |'
    );
  });
  ...
  it('keeps the superseded master PRD historical and below current consent language', () => {
    ...
    expect(docsRegistry).toContain(
      '| `PRD_for_a_web_platform_MVP.master-latest.md` | `historical` | `root` | `repo` | `2026-05-14` |'
    );
  });
  ...
  it('keeps the root privacy architecture reference aligned to proof-review consent language', () => {
    ...
    expect(docsRegistry).toContain(
      '| `DATA_SECURITY_PRIVACY_ARCHITECTURE.md`                                                                 | `reference-spec` | `root`        | `repo`              | `2026-03-11`  |'
    );
  });
  ...
  it('keeps active security evidence docs pointed at existing current or historical sources', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/security-scan-results.md`                                                                         | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps GEO audit scope aligned with active public launch surfaces', () => {
    ...
    expect(docsRegistry).toContain(
      '| `agent/runbooks/geo-audit.md` | `governance` | `agent` | `repo+live` | `2026-03-09` |'
    );
  });
  ...
  it('keeps release batch mechanics below current launch evidence gates', () => {
    ...
    expect(docsRegistry).toContain(
      '| `agent/runbooks/release-batch-flow.md` | `runbook` | `agent` | `repo+live` | `2026-03-11` |'
    );
  });
  ...
  it('keeps scoped verification docs under the locked MVP authority stack', () => {
    ...
    expect(docsRegistry).toContain(
      '| `IDENTITY_VERIFICATION_IMPLEMENTATION.md`                                                               | `active`         | `root`        | `repo+live`         | `2026-03-11`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/verification-policy-mvp.md`                                                                       | `active`         | `docs`        | `repo+live`         | `2026-03-11`  |'
    );
  });
  ...
  it('keeps the testing strategy aligned with production-candidate launch gates', () => {
    ...
    expect(docsRegistry).toContain(
      '| `README.md`                                                                                             | `active`         | `root`        | `repo+live`         | `2026-05-04`  |'
    );
    ...
    expect(docsRegistry).toContain(
      '| `docs/testing-strategy.md`                                                                              | `active`         | `docs`        | `repo+live`         | `2026-04-29`  |'
    );
  });
  ...
  it('keeps environment docs from making connected providers launch-blocking by default', () => {
    ...
    expect(envDocs).toContain('Last Verified: `2026-06-21`');
    ...
    expect(docsRegistry).toContain(
      '| `docs/mvp-launch-master-checklist.md`                                                                   | `active`         | `docs`        | `repo+live`         | `2026-04-29`  |'
    );
  });
  ...
  it('keeps analytics privacy setup scoped to archived routes and no-secret launch evidence', () => {
    ...
    expect(docsRegistry).toContain(
      '| `ANALYTICS_GDPR_SETUP.md`                                                                               | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps alert configuration scoped to launch-safe MVP operations', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/alert-configuration.md`                                                                           | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps monitoring and alerting docs aligned with launch-safe operations', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/monitoring-alerting.md`                                                                           | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps Sentry and structured logging privacy-safe for launch', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/sentry-setup.md`                                                                                  | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/structured-logging.md`                                                                            | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps security policy and incident response no-leak and launch-scoped', () => {
    ...
    expect(docsRegistry).toContain(
      '| `.github/SECURITY.md`                                                                                   | `active`         | `github`      | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/SECURITY_INCIDENT_RESPONSE_RUNBOOK.md`                                                            | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps manual testing docs aligned with the active MVP route corridor', () => {
    ...
    expect(docsRegistry).toContain(
      '| `MANUAL_TESTING_CHECKLIST.md`                                                                           | `reference-spec` | `root`        | `repo`              | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `MANUAL_TESTING_GUIDE.md`                                                                               | `reference-spec` | `root`        | `repo`              | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the admin testing guide and smoke probe scoped to launch ops', () => {
    ...
    expect(docsRegistry).toContain(
      '| `ADMIN_DASHBOARD_TESTING_GUIDE.md`                                                                      | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `audit/admin-dashboard-mvp-ops-review-2026-05-03.md` | `reference-spec` | `audit` | `repo` | `2026-05-04` |'
    );
  });
  ...
  it('keeps the root quick start launch-safe and free of retired migration promises', () => {
    ...
    expect(docsRegistry).toContain(
      '| `QUICK_START.md`                                                                                        | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the logging migration guide scoped to active MVP surfaces', () => {
    ...
    expect(docsRegistry).toContain(
      '| `LOGGING_MIGRATION_GUIDE.md`                                                                            | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps superseded Expertise fix instructions out of active launch guidance', () => {
    ...
    expect(docsRegistry).toContain(
      '| `FIX_INSTRUCTIONS.md`                                                                                   | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps migration runbooks aligned with checkpoint and restore discipline', () => {
    ...
    expect(docsRegistry).toContain(
      '| `APPLY_MIGRATIONS_MANUAL.md`                                                                            | `active`         | `root`        | `repo+live`         | `2026-02-26`  |'
    );
    expect(docsRegistry).toContain(
      '| `RUN_MIGRATIONS_GUIDE.md`                                                                               | `active`         | `root`        | `repo+live`         | `2026-02-26`  |'
    );
  });
  ...
  it('keeps the old RLS deployment summary out of current launch evidence', () => {
    ...
    expect(docsRegistry).toContain(
      '| `RLS_DEPLOYMENT_SUMMARY.md`                                                                             | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the deployment checklist aligned with launch-safe migration and smoke gates', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/DEPLOYMENT_CHECKLIST.md`                                                                          | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the storage setup guide aligned with private upload lifecycle', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/STORAGE_SETUP.md`                                                                                 | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps retired smart search deployment steps out of active launch guidance', () => {
    ...
    expect(docsRegistry).toContain(
      '| `DEPLOYMENT_STEPS_SMART_SEARCH.md`                                                                      | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps retained expertise taxonomy guidance from reviving archived Atlas UI', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/EXPERTISE_ATLAS_SETUP.md`                                                                         | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `data/README-EXPERTISE-ATLAS-SKILLS.md`                                                                 | `reference-spec` | `data`        | `repo`              | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `agent/runbooks/expertise-taxonomy-recovery.md` | `active` | `agent` | `repo+live` | `2026-02-26` |'
    );
  });
  ...
  it('keeps the Supabase setup guide target-agnostic and launch-safe', () => {
    ...
    expect(docsRegistry).toContain(
      '| `SETUP_SUPABASE.md`                                                                                     | `active`         | `root`        | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps the Supabase MCP guide target-agnostic and read-only by default', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/SUPABASE_MCP_SETUP.md`                                                                            | `active`         | `docs`        | `repo+live`         | `2026-03-11`  |'
    );
  });
  ...
  it('keeps the Supabase MCP status note free of stale target snapshots', () => {
    ...
    expect(docsRegistry).toContain(
      '| `MCP_STATUS.md`                                                                                         | `active`         | `root`        | `repo+live`         | `2026-03-11`  |'
    );
  });
  ...
  it('keeps internal ops SOPs current and protected-route scoped', () => {
    ...
    for (const docPath of internalOpsDocs) {
      ...
      const registryLine = docsRegistry
        .split('\n')
        .find((line) => line.includes(`| \`${docPath}\``));
      expect(registryLine).toContain('| `2026-03-25`');
    }
  ...
  it('keeps April launch signoff files historical, not current go/no-go proof', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/internal-ops/launch-owner-roster-2026-04-27.md`                                                   | `active`         | `docs`        | `repo+live`         | `2026-04-27`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/internal-ops/production-launch-evidence-2026-04-27.md`                                            | `active`         | `docs`        | `repo+live`         | `2026-04-27`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/launch-signoff-2026-04-27.md`                                                                     | `active`         | `docs`        | `repo+live`         | `2026-04-27`  |'
    );
  });
  ...
  it('keeps launch signoff and QA guidance tied to current target evidence', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/full-launch-signoff-memo-template.md`                                                             | `active`         | `docs`        | `repo`              | `2026-04-15`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/qa/bugs.md`                                                                                       | `active`         | `docs`        | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `docs/qa/summary.md`                                                                                    | `active`         | `docs`        | `repo+live`         | `2026-05-04`  |'
    );
  });
  ...
  it('keeps February project flow and PR triage snapshots historical', () => {
    ...
    expect(docsRegistry).toContain(
      '| `project/MVP_FLOW_MATRIX_2026-02-12.md`                                                                 | `active`         | `project`     | `repo+live`         | `2026-02-12`  |'
    );
    expect(docsRegistry).toContain(
      '| `project/PR_TRIAGE_2026-02.md`                                                                          | `active`         | `project`     | `repo+live`         | `2026-02-12`  |'
    );
  });
  ...
  it('keeps launch operations guidance aligned with the current MVP corridor', () => {
    ...
    expect(docsRegistry).toContain(
      '| `docs/launch-operations-mvp.md`                                                                         | `active`         | `docs`        | `repo+live`         | `2026-03-25`  |'
    );
  });
  ...
  it('keeps active submission invite failure copy proof-submission scoped', () => {
    ...
    expect(combined).toContain('No owner-only proof record is ready for this assignment yet.');
    expect(combined).toContain('Assignment review invite accepted');
    expect(combined).toContain('Accept assignment review');
    expect(combined).toContain(
      'Assignment proof submissions can only submit an owner-only proof record'
    );
  ...
  it('keeps active readiness and intro copy eligibility-led instead of unlock-led', () => {
    ...
    expect(activeReadinessCopy).toContain('Public Page link ready');
    ...
    expect(activeReadinessCopy).toContain('Verification upgrades the trust badge later');
    ...
    expect(activeReadinessCopy).toContain('Set assignment-review preferences');
    expect(activeReadinessCopy).toContain('Assignment review preferences');
    expect(activeReadinessCopy).toContain('assignment reviews stay relevant');
    expect(activeReadinessCopy).toContain('assignments should reach you');
    ...
    for (const staleCopy of [
      ...
      'Set matching constraints',
      'Create your matching profile',
      'Browse profile',
      'match-visible',
      'make matching ready',
  ...
  it('keeps account verification emails and tours proof-review led', () => {
    ...
    expect(activeTourCopy).toContain('Review reason-coded proof context');
  ...
  it('keeps active signup and review-entry copy workflow-scoped', () => {
    ...
    expect(workflowEntryCopy).toContain('Open assignment review');
    ...
    expect(workflowEntryCopy).toContain('Assignment review workspace');
    expect(workflowEntryCopy).toContain('Preparing assignment review workspace');
    expect(workflowEntryCopy).toContain('Preparing assignment reviews');
    expect(workflowEntryCopy).toContain('Assignment reviews could not load');
    expect(workflowEntryCopy).toContain('Retry assignment reviews');
    expect(workflowEntryCopy).toContain('No assignment reviews yet');
    expect(workflowEntryCopy).toContain('assignment reviews can stay relevant');
    ...
    expect(workflowEntryCopy).toContain('Review proof-backed submissions');
    ...
    expect(workflowEntryCopy).toContain('Set your proof-review preferences');
    ...
    expect(workflowEntryCopy).toContain('proof-led assignment-review flow');
  ...
  it('keeps strict organization E2E copy assignment-review scoped', () => {
    ...
    expect(strictOrgE2eCopy).toContain('Create first assignment');
