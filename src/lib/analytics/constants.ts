...
export function getEventDisplayName(eventType: EventTypeValue): string {
  const names: Record<EventTypeValue, string> = {
    ...
    [EventType.ATTESTATION_REQUESTED]: 'Confirmation Requested',
    [EventType.ATTESTATION_PROVIDED]: 'Confirmation Provided',
    ...
    [EventType.PROOF_PACK_CREATED]: 'Proof Record Created',
    [EventType.PROOF_PACK_DELETED]: 'Proof Record Deleted',
    [EventType.PROOF_PACK_FRESHNESS_STATE_CHANGED]: 'Proof Record Freshness State Changed',
