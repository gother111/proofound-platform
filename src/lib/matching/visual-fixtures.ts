  ...
  return [
    {
      ...
      rankBand: null,
      why: {
        summary: ['Strong evidence overlap', 'Fresh anchored proof supports the flow.'],
        sections: [
          {
      ...
      reviewCard: {
        ...
        fitSummary: {
          ...
          bullets: [
            ...
            'Trust anchor is present for the relevant proof flow.',
    ...
    },
    {
      ...
      rankBand: null,
      why: {
        summary: ['Intro already open', 'Alias and proof text evidence supported the flow.'],
        sections: [
          {
