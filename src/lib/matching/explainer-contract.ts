...
export const MATCH_EXPLAINER_DIALOG_DESCRIPTION =
  'Blind-by-default review keeps identity-bearing details hidden until candidate consent allows reveal. Review the strongest proof, fit rationale, privacy-safe constraints, and only then the comparative score detail.';
