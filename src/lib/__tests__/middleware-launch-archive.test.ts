...
describe('middleware launch archive behavior', () => {
  ...
  it('returns 410 for archived non-MVP APIs', async () => {
    const archivedPaths = [
      ...
      ['http://localhost/api/profile/completeness', 'Profiles API'],
      ['http://localhost/api/analytics/events', 'Analytics API'],
      ['http://localhost/api/analytics/tour-event', 'Analytics API'],
      ...
      ['http://localhost/api/cron/account-deletion-workflow', 'Workflow Cron API'],
      ['http://localhost/api/cron/process-deletions', 'Workflow Cron API'],
      ['http://localhost/api/cron/send-deletion-reminders', 'Workflow Cron API'],
      ['http://localhost/api/user/account/cancel-deletion', 'User API'],
      ['http://localhost/api/user/audit-log/purpose', 'User API'],
      ['http://localhost/api/expertise/cv-import/wizard-apply', 'Legacy Expertise API'],
      ['http://localhost/api/expertise/cv-import/wizard-extract', 'Legacy Expertise API'],
      ['http://localhost/api/expertise/cv-import/wizard-extract/status', 'Legacy Expertise API'],
      ['http://localhost/api/organizations/org-1/projects/project-1', 'Organization Suite API'],
      ['http://localhost/api/organizations/org-1/goals', 'Organization Suite API'],
      ['http://localhost/api/organizations/org-1/partnerships', 'Organization Suite API'],
      ['http://localhost/api/organizations/org-1/structure', 'Organization Suite API'],
      ['http://localhost/api/organizations/org-1/culture', 'Organization Suite API'],
      ['http://localhost/api/organizations/org-1/impact', 'Organization Suite API'],
      ['http://localhost/api/org/org-1/dashboard', 'Organization Suite API'],
      ['http://localhost/api/org/org-1/coverage', 'Organization Suite API'],
  ...
  it('returns 404 for archived page routes before they become reachable', async () => {
    const archivedPaths = [
      ...
      'http://localhost/app/o/acme/impact',
      'http://localhost/app/o/acme/structure',
      'http://localhost/app/o/acme/partnerships',
      'http://localhost/app/o/acme/analytics/fairness',
      'http://localhost/app/o/acme/settings/profile',
      'http://localhost/app/o/acme/settings/goals',
