...
function buildPrompt(context: SanitizedAssignmentContext) {
  return [
    ...
    'Do not create proof-review participant evaluation rubrics, ordering, suitability verdicts, trust levels, verification approvals, interview recommendations, engagement recommendations, or review decisions.',
