 ...
 *
 * Gets explicit consent before sharing a proof snapshot with an organization
  ...
  const renderModalContentBody = () => (
    <div className="space-y-6 px-4 md:px-0">
      <ConsentExplainer
        ...
        whyThisRequestExists={`This share lets ${organizationName} review your proof-backed snapshot for the ${assignmentRole} role and request the next workflow stage. It does not auto-reveal contact details or weaken blind review on future requests.`}
