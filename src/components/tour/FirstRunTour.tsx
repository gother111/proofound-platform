...
const individualTourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description:
      'This sidebar is your launch map. Access your overview, profile, Proof Packs, assignment review, and settings from here.',
    icon: Compass,
  ...
  },
  {
    ...
    description:
      'You can restart this tour anytime from Settings. Start with one Proof Pack, then prepare assignment reviews when proof and privacy are ready.',
    icon: Home,
    placement: 'center',
  },
];
