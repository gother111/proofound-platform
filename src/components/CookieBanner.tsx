            ...
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                >
                  <Link
                    href="/privacy"
                    className="-mx-1.5 inline-flex min-h-[44px] items-center rounded-md px-1.5 text-proofound-forest underline-offset-4 transition-colors hover:bg-proofound-forest/5 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-proofound-forest focus-visible:ring-offset-2"
                  >
                    Privacy Policy
                  </Link>
                  <Link
