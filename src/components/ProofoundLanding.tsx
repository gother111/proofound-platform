        ...
        <div className="mx-auto flex max-w-[88rem] items-center justify-between gap-3 rounded-full px-1 py-0 md:gap-6 md:px-4">
          <div className="flex min-w-0 items-center gap-4">
            <Link
              ...
              className="flex min-h-11 min-w-11 items-center gap-3 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-proofound-forest/35 focus-visible:ring-offset-4 focus-visible:ring-offset-[#f6f2ea]"
            >
              <Image
                src="/logo.png"
                alt="Proofound"
          ...
          <nav className="hidden items-center gap-10 text-[1.02rem] text-foreground/66 lg:flex">
            <a
              href="#story"
              className="inline-flex min-h-11 items-center rounded-full px-1 transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-proofound-forest/35 focus-visible:ring-offset-4 focus-visible:ring-offset-[#f6f2ea]"
            >
              How it works
            </a>
            <a
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/login"
              className="inline-flex min-h-11 items-center rounded-full px-2 text-[0.8rem] font-medium text-foreground/78 transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-proofound-forest/35 focus-visible:ring-offset-4 focus-visible:ring-offset-[#f6f2ea] sm:px-3 lg:hidden"
            >
              Sign in
            </Link>
            <Link
              href="/login"
              className="hidden min-h-11 items-center rounded-full px-1 text-[1.02rem] text-foreground/82 transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-proofound-forest/35 focus-visible:ring-offset-4 focus-visible:ring-offset-[#f6f2ea] lg:inline-flex"
            >
              Sign in
            </Link>
            <button
