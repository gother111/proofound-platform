...
interface OrganizationPurposeProps {
    mission?: string;
    vision?: string;
    culture?: any; // Using any for culture object structure flexibility
}

export function OrganizationPurpose({ mission, vision, culture }: OrganizationPurposeProps) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Card className="border-0 shadow-md bg-gradient-to-br from-white to-proofound-parchment dark:from-stone-900 dark:to-stone-950 overflow-hidden">
                ...
                <CardContent className="space-y-6">
                    {mission && (
                        <div>
                            <h4 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-2">Mission</h4>
                    ...
                    {vision && (
                        <div>
                            <h4 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-2">Vision</h4>
                ...
                <CardContent>
                    {culture ? (
                        <div className="space-y-4">
                            ...
                            {/* Add culture tags or summary here if available in the culture object */}
                            <div className="flex flex-wrap gap-2">
                                ...
                                {/* Placeholder tags - replace with real data mapping */}
                            </div>
                        </div>
                    ) : (
