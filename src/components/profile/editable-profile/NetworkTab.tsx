    ...
    <TabsContent value="network">
      <Card className="p-8 border-2">
        <div className="text-center mb-8">
          ...
          <h3 className="text-2xl font-display font-semibold mb-2">Review relationships</h3>
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
            Launch review relationships stay assignment-bound and proof-first. This area is reserved
            for consented intros, reveal decisions, and interview follow-up rather than a broad
            social graph.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
          <div className="text-center p-4 bg-muted/20 rounded-xl border border-transparent hover:border-[#7A9278]/20 hover:bg-[#7A9278]/5 transition-colors group">
            ...
            <p className="text-xs text-muted-foreground mt-1">Consented intro contacts only</p>
          </div>
          <div className="text-center p-4 bg-muted/20 rounded-xl border border-transparent hover:border-[#C67B5C]/20 hover:bg-[#C67B5C]/5 transition-colors group">
            ...
            <p className="text-2xl font-semibold">Held</p>
            <p className="text-xs text-muted-foreground mt-1">Assignment-review context only</p>
          </div>
          <div className="text-center p-4 bg-muted/20 rounded-xl border border-transparent hover:border-[#5C8B89]/20 hover:bg-[#5C8B89]/5 transition-colors group">
            ...
            <p className="text-2xl font-semibold">Held</p>
            <p className="text-xs text-muted-foreground mt-1">Verification context only</p>
          </div>
        </div>
