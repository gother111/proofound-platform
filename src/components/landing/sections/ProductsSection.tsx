  ...
  const plans = [
    {
      ...
      price: 'Free',
      period: 'forever',
      desc: 'For professionals who want a day-1 public proof portfolio and portable credibility.',
      features: [
    ...
    },
    {
      ...
      price: 'Custom',
      period: 'per seat',
      desc: 'For teams that need a public credibility surface first, then hiring workflows.',
      features: [
