...
export function EmptyStatePanel({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center justify-center text-center border-dashed font-medium w-full transition-all duration-300 glass-panel hover:bg-white/70 dark:hover:bg-[#1A1D2E]/80',
