...
export default function SupportPage() {
  return (
    ...
    >
      ...
      <p className="text-base leading-relaxed text-muted-foreground">
        Policy and privacy requests should cite the relevant policy section to speed review. If you
        are requesting account deletion, export, or consent changes, include the account email and
        preferred response channel. We aim for transparent status updates until the request is
        resolved.
      </p>
      <p className="text-base leading-relaxed text-muted-foreground">
        If you are reporting reproducible defects, include screen recordings or request traces where
        possible. Concrete artifacts reduce triage latency and improve fix accuracy. We prioritize
        issues by user impact, security exposure, and operational risk, and we share updates until
        closure.
      </p>
      <ul className="list-disc space-y-2 pl-6 text-base leading-relaxed text-muted-foreground">
        ...
        <li>
          ...
          <Link href="mailto:privacy@proofound.com" className="font-semibold text-proofound-forest">
