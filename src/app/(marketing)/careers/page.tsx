  ...
  return (
    ...
    >
      ...
      <p className="text-base leading-relaxed text-muted-foreground">
        ...
        complex workflows more understandable for real users. We review every submission and keep a
        talent pipeline for future openings.
      </p>
      <p className="text-base leading-relaxed text-muted-foreground">
        Our hiring process is structured to reduce ambiguity and bias. You can expect clear role
        scopes, practical conversations with future collaborators, and transparent next steps after
        each stage. We prioritize signal over performance theater and value thoughtful problem
        framing as much as implementation speed.
      </p>
      <p className="text-base leading-relaxed text-muted-foreground">
        We support continuous growth with explicit feedback loops, mentoring, and project ownership
        that stretches both technical and product judgment. Career progression is tied to impact,
        collaboration quality, and stewardship of user trust, not to internal visibility alone.
      </p>
    </MarketingPage>
  );
}
