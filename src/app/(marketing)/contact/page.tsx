...
export default function ContactPage() {
  ...
  return (
    <>
      <JsonLdScripts items={jsonLdItems} idPrefix="contact-jsonld" />
      <MarketingPage
      ...
      >
        ...
        <p className="text-base leading-relaxed text-muted-foreground">
          ...
          relevant logs or screenshots. Responsible disclosure reports are triaged quickly and
          handled confidentially.
        </p>
        <p className="text-base leading-relaxed text-muted-foreground">
          If your request is policy-related, include the policy page and section reference so we can
          route it to the right owner. We aim to provide practical, actionable responses and
          follow-up timelines for unresolved issues.
        </p>
        <p className="text-base leading-relaxed text-muted-foreground">
        ...
        <p className="text-base leading-relaxed text-muted-foreground">
          For follow-up requests, include the previous email thread reference so context is
          preserved. This helps us avoid duplicate triage and improves turnaround for complex
          cross-team issues that involve product, operations, and policy owners.
        </p>
        <p className="text-base leading-relaxed text-muted-foreground">
          If you prefer asynchronous updates, mention that in your first message and we will provide
          a status cadence with clear owners and checkpoints. We keep responses action-oriented,
          with explicit next steps and expected timelines whenever additional investigation is
          needed.
        </p>
        <Link
