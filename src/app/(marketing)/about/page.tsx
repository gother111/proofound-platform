...
export default function AboutPage() {
  ...
  return (
    <>
      <JsonLdScripts items={jsonLdItems} idPrefix="about-jsonld" />
      <MarketingPage
      ...
      >
        <p className="text-base leading-relaxed text-muted-foreground">
          ...
          values/causes. The goal is faster, values-aligned introductions that reduce bias and
          shorten time-to-first qualified intro and time-to-value.
        </p>
        <p className="text-base leading-relaxed text-muted-foreground">
          Privacy and consent are default. There is no social feed or engagement vanity, just
          transparent guardrails, fairness checks, and user-controlled visibility so both
        ...
        <p className="text-base leading-relaxed text-muted-foreground">
          Our operating model favors accountability over growth hacks. We continuously review
          policy, accessibility, and security outcomes to keep the platform safe and useful. The
          result is a calmer hiring and collaboration experience where capability, values, and trust
          are easier to assess from the first interaction.
        </p>
        <p className="text-base leading-relaxed text-muted-foreground">
