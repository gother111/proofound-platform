    ...
    >
      <div className="space-y-4 text-base leading-relaxed text-muted-foreground">
        ...
        <p>
          ...
          platform needs. We avoid broad tracking scopes and only keep technical identifiers for as
        ...
        <p>
          When you revisit this page, your latest consent state is reflected in controls so you can
          confirm or revise decisions without guesswork. We design cookie controls to be readable,
          reversible, and aligned with practical user expectations for transparency.
        </p>
        <p>
          Where possible, we prefer privacy-preserving defaults and avoid category sprawl. This
          policy exists to make implementation choices legible, so users understand what each cookie
          category does and how it impacts experience, measurement, and platform safety.
        </p>
      </div>
      <Link
