...
export function SearchModePanel({
  ...
  return (
    <div className="mt-6 space-y-4">
      <div>
        <Label htmlFor="skill-search" className="text-foreground mb-2 block">
          Search for a skill
        </Label>
      ...
      {searchError && (
        <div className="text-center py-8 text-proofound-terracotta bg-[#FFF0F0] rounded-lg border border-[#C76B4A]">
      ...
      {!searchLoading && searchResults.length > 0 && (
        <div className="space-y-2 max-h-[500px] overflow-y-auto">
          ...
          {bulkSelection.size > 0 && (
            <div className="flex items-center justify-between bg-japandi-bg border border-proofound-stone rounded-lg px-3 py-2 text-sm">
