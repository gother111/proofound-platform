      ...
      <div className="relative z-10">
        <header className="border-b border-proofound-stone bg-white/80 backdrop-blur-sm">
          <div className="mx-auto max-w-4xl px-6 py-6">
            <Link
              href="/"
              className="-ml-2 inline-flex min-h-10 items-center gap-2 rounded-md px-2 text-sm text-[#2D333099] transition-colors hover:bg-proofound-terracotta/5 hover:text-proofound-terracotta focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-proofound-terracotta focus-visible:ring-offset-2"
            >
          ...
          <Card className="rounded-2xl border border-proofound-stone bg-white p-10 shadow-[0_4px_24px_rgba(29,51,48,0.08)]">
            <div className="space-y-8 text-[#2D3330CC]">
              ...
              <section>
                ...
                <p className="mt-3 leading-7">
                  Proofound is a proof-first assignment-review flow centered on proof records,
