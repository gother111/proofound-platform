...
INSERT INTO skills_categories (cat_id, slug, name_i18n, description_i18n, icon, display_order, version, status, created_at, updated_at)
VALUES (2, 'f', '{"en": "Functional Competencies"}', '{"en": "Functional Competencies domain"}', 'Briefcase', 2, 1, 'active', NOW(), NOW())
ON CONFLICT (cat_id) DO NOTHING;

INSERT INTO skills_categories (cat_id, slug, name_i18n, description_i18n, icon, display_order, version, status, created_at, updated_at)
VALUES (3, 't', '{"en": "Tools & Technologies"}', '{"en": "Tools & Technologies domain"}', 'Briefcase', 3, 1, 'active', NOW(), NOW())
ON CONFLICT (cat_id) DO NOTHING;

INSERT INTO skills_categories (cat_id, slug, name_i18n, description_i18n, icon, display_order, version, status, created_at, updated_at)
VALUES (4, 'l', '{"en": "Languages & Culture"}', '{"en": "Languages & Culture domain"}', 'Briefcase', 4, 1, 'active', NOW(), NOW())
ON CONFLICT (cat_id) DO NOTHING;

INSERT INTO skills_categories (cat_id, slug, name_i18n, description_i18n, icon, display_order, version, status, created_at, updated_at)
VALUES (5, 'm', '{"en": "Methods & Practices"}', '{"en": "Methods & Practices domain"}', 'Briefcase', 5, 1, 'active', NOW(), NOW())
ON CONFLICT (cat_id) DO NOTHING;

INSERT INTO skills_categories (cat_id, slug, name_i18n, description_i18n, icon, display_order, version, status, created_at, updated_at)
VALUES (6, 'd', '{"en": "Domain Knowledge"}', '{"en": "Domain Knowledge domain"}', 'Briefcase', 6, 1, 'active', NOW(), NOW())
ON CONFLICT (cat_id) DO NOTHING;
