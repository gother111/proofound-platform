...
The old customizable/draggable individual and organization dashboard shells live here as historical implementation context.
...
Do not move these modules back into active `src/components/dashboard` or `src/app/app/*/home` unless the locked MVP source of truth changes.
