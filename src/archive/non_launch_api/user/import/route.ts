      ...
      for (const pack of data.proof.packs) {
        ...
        await tx
          ...
          .values({
            ...
            primaryClaimType: anchoredPack.primaryClaimType ?? null,
            title: anchoredPack.title,
            summary: anchoredPack.summary,
            contextJson: anchoredPack.contextJson,
            roleContext: anchoredPack.roleContext ?? null,
            ownershipStatement: anchoredPack.ownershipStatement ?? null,
            timeframeStart: anchoredPack.timeframeStart ?? null,
            timeframeEnd: anchoredPack.timeframeEnd ?? null,
            timeframeLabel: anchoredPack.timeframeLabel ?? null,
            evidenceSummary: anchoredPack.evidenceSummary,
            outcomesSummary: anchoredPack.outcomesSummary,
            verificationSummary: anchoredPack.verificationSummary ?? null,
            ...
            proofQualityScore:
              anchoredPack.proofQualityScore != null
                ? String(anchoredPack.proofQualityScore)
                : null,
            schemaVersion: anchoredPack.schemaVersion ?? 'proof_pack/v2',
